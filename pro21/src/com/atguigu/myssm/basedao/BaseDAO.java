    ...
    private void setValue(Object obj ,  String property , Object propertyValue) throws NoSuchFieldException, IllegalAccessException, ClassNotFoundException, NoSuchMethodException, InvocationTargetException, InstantiationException {
        ...
        if(field!=null){
            ...
            if(isMyType(typeName)){
                ...
                Constructor constructor = typeNameClass.getDeclaredConstructor(propertyValue.getClass());
...
//    @Test
//    public void test() throws NoSuchFieldException, ClassNotFoundException, InvocationTargetException, IllegalAccessException, NoSuchMethodException, InstantiationException {
//        Reply re = new Reply();
//        String s="彼此";
//        setValue(re,"auther",s);
